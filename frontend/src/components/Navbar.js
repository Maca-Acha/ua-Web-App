          ...
          <div className="mx-auto px-2 sm:px-6 lg:px-8">
            <div className="relative flex items-center justify-between h-16">
              ...
              <div className="flex-shrink-0 flex items-center">
                <div className="flex-shrink-0 flex items-center">
                  {/* <img
                    className="block lg:hidden h-8 mx-56 md:mx-0 w-auto"
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.current
                          ? "bg-purple-600 fw-bold text-white"
              ...
              <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <Menu as="div" className="ml-3 relative z-10">
                  ...
                  >
                    <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-zinc-900 ring-1 ring-black ring-opacity-5 focus:outline-none">
                      {true ? (
                        <>
                          <Menu.Item>
                            {({ active }) => (
